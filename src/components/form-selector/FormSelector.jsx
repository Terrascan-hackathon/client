...
const FormSelector = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        console.log(date, location, type);
        dispatch(getData(date, location, type))
    }
    ...
    return (
        ...
        >
            ...
            <TextField id="location" label="Location" variant="outlined" type="text" onChange={(e) => setLocation(e.target.value)} />
            <TextField
                select
                label='Type'
                sx={{ mb: 2 }}
